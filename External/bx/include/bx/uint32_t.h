...
namespace bx
{
	const uint16_t kHalfFloatZero = UINT16_C(0);
	const uint16_t kHalfFloatHalf = UINT16_C(0x3800);
	const uint16_t kHalfFloatOne  = UINT16_C(0x3c00);
	const uint16_t kHalfFloatTwo  = UINT16_C(0x4000);

...
//printf("GAINPUT msg.message = %d\n", msg.message);
		...
		// WM_KILLFOCUS doesn't work :(
		// Sent to a window immediately before it loses the keyboard focus.
		//HACK to avoid "sticky" movement keys after resuming from a breakpoint.
		case 49214://??? :
			state_->ResetButtonsState();
			nextState_.ResetButtonsState();
			return;

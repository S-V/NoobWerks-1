												 ...
												 ConvexResultCallback& resultCallback, btScalar allowedPenetration)
{
	...
	else
	{
		if (collisionShape->isConcave())
		{
			//SVD: added BIH_SHAPE_PROXYTYPE
			if( collisionShape->getShapeType() == BIH_SHAPE_PROXYTYPE )
			{
				extern void btExtension_objectQuerySingleInternal_BIH_Shape(
				...
				btExtension_objectQuerySingleInternal_BIH_Shape(

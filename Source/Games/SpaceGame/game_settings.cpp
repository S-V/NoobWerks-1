...
mxDEFINE_CLASS(InGameVideoSettings);
mxBEGIN_REFLECTION(InGameVideoSettings)
	mxMEMBER_FIELD( enable_vsync ),
mxEND_REFLECTION;
InGameVideoSettings::InGameVideoSettings()
{
	enable_vsync = true;
}
...
mxBEGIN_REFLECTION(MyGameplaySettings)
	mxMEMBER_FIELD( highlight_enemies ),
mxEND_REFLECTION;
...
mxDEFINE_CLASS(SgDeveloperSettings);
mxBEGIN_REFLECTION(SgDeveloperSettings)
	mxMEMBER_FIELD( show_hud ),
	mxMEMBER_FIELD( visualize_BVH ),
	mxMEMBER_FIELD( use_mesh_LODs ),
	mxMEMBER_FIELD( use_multithreaded_update ),
mxEND_REFLECTION;
SgDeveloperSettings::SgDeveloperSettings()
{
	show_hud = false;
	visualize_BVH = false;
	use_mesh_LODs = true;
	use_multithreaded_update = true;
}

mxDEFINE_CLASS(SgUserSettings);
mxBEGIN_REFLECTION(SgUserSettings)
	mxMEMBER_FIELD( ingame ),
	mxMEMBER_FIELD( window ),
	mxMEMBER_FIELD( developer ),
mxEND_REFLECTION;
...
void SgUserSettings::SetDefaults()
{
	window.SetDefaults();
	developer = SgDeveloperSettings();
}
...
mxDEFINE_CLASS(SgCheatSettings);
mxBEGIN_REFLECTION(SgCheatSettings)
...
mxEND_REFLECTION;
SgCheatSettings::SgCheatSettings()
{
	enable_noclip = false;
...
mxDEFINE_CLASS(SgAppSettings);
mxBEGIN_REFLECTION(SgAppSettings)
	...
	mxMEMBER_FIELD_WITH_CUSTOM_NAME( dev_show_voxel_engine_settings, Show_Voxel_Engine_Settings ),
	mxMEMBER_FIELD_WITH_CUSTOM_NAME( dev_show_voxel_engine_debug_menu, Show_Voxel_Debug_Menu ),
...
void SgAppSettings::FixBadValues()
{

...
-----------------------------------------------------------------------------
*/
SgGameState_DoYouReallyWannaExit::SgGameState_DoYouReallyWannaExit()
{
	is_window_open = true;
}

ERet SgGameState_DoYouReallyWannaExit::Initialize(
									   )
{
	return ALL_OK;
}

void SgGameState_DoYouReallyWannaExit::Shutdown()
{
}

EStateRunResult SgGameState_DoYouReallyWannaExit::handleInput(
	NwAppI* game_app
...
void SgGameState_DoYouReallyWannaExit::DrawUI(
	const NwTime& game_time
	, NwAppI* game_app
	)
{

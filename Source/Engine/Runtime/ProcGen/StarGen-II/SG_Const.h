...
#define pow1_3(a)  pow((long double)a, (long double)(0.3333333))
#define pow2_3(a)  pow((long double)a, (long double)(0.6666666))
#define pow4_3(a)  pow((long double)a, (long double)(1.3333333))
#define pow1_4(a)  sqrt(sqrt(a))
#define pow1_8(a)  pow((long double)a, (long double)0.125)

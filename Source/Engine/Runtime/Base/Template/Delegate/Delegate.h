...
class TCallback< R () >
{
	...
	FuncType 		m_func;	// always valid
	const void *	m_obj;	// null if free (i.e. non-member) function
...
public:
	...
	inline const CLASS* ToClassPtr() const
	{
		return static_cast< const CLASS* >( m_obj );
	}
...
public:
	...
	inline const CLASS* ToClassPtr() const
	{
		return static_cast< const CLASS* >( obj );
	}
private:
	typedef const void* TCallback::*SafeBoolType;
public:
	inline operator SafeBoolType() const
	{ return func != nil ? &TCallback::obj : nil; }
	inline bool operator!() const
	{ return func == nil; }
...
public:
	...
	TArray< CallbackType >	m_delegates;

public:

	template< class CLASS, void (CLASS::*FUNC)() >
	void Connect( CLASS& pObj, void (CLASS::*pFunc)() )
	{
	...
	template< class CLASS, void (CLASS::*FUNC)() >
	void Disconnect( CLASS& pObj, void (CLASS::*pFunc)() )
	{
		m_delegates.Remove(
			GetCallbackFactory( pFunc ).MakeCallback< FUNC >( pObj )
		);
	...
	void Emit() const
	{
		...
		const CallbackType* pDelegates = m_delegates.raw();
...
public:
	...
	template< class CLASS, void (CLASS::*FUNC)( P0 p0 ) >
	void Connect( CLASS& pObj, void (CLASS::*pFunc)( P0 p0 ) )
	{
		m_delegates.AddUnique(
			GetCallbackFactory( pFunc ).MakeCallback< FUNC >( pObj )
		);
...
public:
	...
	template< class CLASS, void (CLASS::*FUNC)( P0, P1 ) >
	void Connect( CLASS& pObj, void (CLASS::*pFunc)( P0, P1 ) )
	{
		m_delegates.AddUnique(
			GetCallbackFactory( pFunc ).MakeCallback< FUNC >( pObj )
		);
...
public:
	...
	template< class CLASS, void (CLASS::*FUNC)( P0, P1, P2 ) >
	void Connect( CLASS& pObj, void (CLASS::*pFunc)( P0, P1, P2 ) )
	{
		m_delegates.AddUnique(
			GetCallbackFactory( pFunc ).MakeCallback< FUNC >( pObj )
		);
...
public:
	...
	template< class CLASS, void (CLASS::*FUNC)( P0, P1, P2, P3 ) >
	void Connect( CLASS& pObj, void (CLASS::*pFunc)( P0, P1, P2, P3 ) )
	{
		m_delegates.AddUnique(
			GetCallbackFactory( pFunc ).MakeCallback< FUNC >( pObj )
		);
...
public:
	...
	template< class CLASS, void (CLASS::*FUNC)( P0, P1, P2, P3, P4 ) >
	void Connect( CLASS& pObj, void (CLASS::*pFunc)( P0, P1, P2, P3, P4 ) )
	{
		m_delegates.AddUnique(
			GetCallbackFactory( pFunc ).MakeCallback< FUNC >( pObj )
		);
...
#define mxCONNECT( EVENT, CLASS, FUNCTION, INSTANCE )\
	EVENT.Connect< CLASS, &CLASS::FUNCTION >( INSTANCE, &CLASS::FUNCTION )
...
// NOTE: 'INSTANCE' must be a reference.

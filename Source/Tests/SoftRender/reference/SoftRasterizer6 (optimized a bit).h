				...
				for( UINT iY = iBlockY; iY < iBlockY + BLOCK_SIZE; iY++ )
				{
					for( UINT iX = iBlockX; iX < iBlockX + BLOCK_SIZE; iX++ )
					{
						...
						if( thisDepth < prevDepth )
						{
							...
							//for( UINT i = 0; i < NUM_VARYINGS; i++ ) {
							//	const Vector4 tmpV1 = pixelShaderInput.v[i] * fW1;
							//	const Vector4 tmpV2 = pixelShaderInput.v[i] * fW2;
							//	const Vector4 tmpV3 = pixelShaderInput.v[i] * fW3;
							//	//const Vector4 V = tmpV1 * 

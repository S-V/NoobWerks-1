...
-----------------------------------------------------------------------------
*/
RTSGameState_DoYouReallyWannaExit::RTSGameState_DoYouReallyWannaExit()
{
	is_window_open = true;
}

ERet RTSGameState_DoYouReallyWannaExit::Initialize(
									   )
{
	return ALL_OK;
}

void RTSGameState_DoYouReallyWannaExit::Shutdown()
{
}

EStateRunResult RTSGameState_DoYouReallyWannaExit::handleInput(
	NwGameI* game_app
...
void RTSGameState_DoYouReallyWannaExit::drawUI(

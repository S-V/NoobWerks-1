...
-----------------------------------------------------------------------------
*/
RTSGameState_GamePaused::RTSGameState_GamePaused()
{
	is_window_open = true;
}

ERet RTSGameState_GamePaused::Initialize(
									   )
{
	return ALL_OK;
}

void RTSGameState_GamePaused::Shutdown()
{
}

EStateRunResult RTSGameState_GamePaused::handleInput(
	NwGameI* game_app
...
void RTSGameState_GamePaused::drawUI(

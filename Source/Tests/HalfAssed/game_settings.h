...
#include <Renderer/Renderer.h>	// RrDirectionalLight
...
public:	// Debugging / Terrain
	...
	bool 	show_editor_for_NwWeaponDef;//!< debugging
...
public:
	mxDECLARE_CLASS(MyGameSettings, CStruct);
	mxDECLARE_REFLECTION;
	MyGameSettings();
